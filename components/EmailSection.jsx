        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    <Link href="https://github.com/sebasdiii">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/weng-thim-chong">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://www.instagram.com/sebastian__0516/" className="mt-1">
                        <Image src={InstagramIcon}/>
                    </Link>
                    <Link href="mailto:chongwengthim@gmail.com" className="mt-1">
                        <Image src={GmailIcon}/>
                    </Link>
